...
<head>
    ...
    <asset:stylesheet src="font-awesome/css/all.min.css"/>
    <asset:stylesheet src="adminlte.min.css"/>
    <asset:link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700&display=fallback"/>

    <%-- public/AdminLTE-3.2.0/dist/css/adminlte.min.css --%>
